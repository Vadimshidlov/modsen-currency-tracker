...
import "@/pages/TimelinePage/components/CurrencyCards/CurrencySelect.scss";
...
import { CurrencyCardsPropsType, CurrencyCardsStateType } from "@/types/TimeLinePageTypes";
