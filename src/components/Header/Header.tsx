...
import ToggleTheme from "@/components/Header/ToggleTheme/index";
import { HeaderPropsType } from "@/types/TimeLinePageTypes";
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {isBurgerOpen && <BlurBackground onClick={this.handleCloseBurger} />}
                <nav
                    className={
                        isBurgerOpen
